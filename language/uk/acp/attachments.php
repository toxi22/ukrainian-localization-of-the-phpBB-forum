...
$lang = array_merge($lang, [
	...
	'IMAGE_QUALITY'				=> 'Якість завантажуються зображень (тільки для JPEG)',
	'IMAGE_QUALITY_EXPLAIN'		=> 'Вказується значення між 50% (меньший розмір готового файлу) та 90% (краща якість). Якість вище 90% збільшує розмір готового файлу і тому це відключено. Ця установка діє тільки в разі, якщо встановлені максимальні розміри рисунків, відмінні від 0 x 0 пікс.',
	'IMAGE_STRIP_METADATA'		=> 'Видаляти метадані зображення (тільки для JPEG)',
	'IMAGE_STRIP_METADATA_EXPLAIN'	=> 'Видаляти метадані Exif, такі як ім\'я автора, координати GPS і параметри зйомки. Налаштування діє тільки в разі, якщо встановлені максимальні розміри рисунків, відмінні від 0 x 0 пікс.',
	...
	'NO_EXT_GROUP'				=> 'Немає',
	'NO_EXT_GROUP_ALLOWED_PM'	=> 'Відсутні <a href="%s">дозволені групи розширень</a> для особистих повідомлень.',
