...
$lang = array_merge($lang, [
	...
	'FOLDER_STATUS_MSG'			=> array(
		1	=> 'Папка заповнена на %3$d%% (%2$d з %1$s)',
		2	=> 'Папка заповнена на %3$d%% (%2$d з %1$s)',
	),
	...
	'NOTIFICATION_TYPE_FORUM'							=> 'У форумі, на який ви підписані, з\'явилися нові повідомлення',
	...
	'NOTIFICATION_TYPE_REPORT_CLOSED'					=> 'Ваша скарга на повідомлення закрита модератором',
	'NOTIFICATION_TYPE_REPORT_PM'						=> 'Надійшла скарга на приватне повідомлення',
	'NOTIFICATION_TYPE_REPORT_PM_CLOSED'				=> 'Ваша скарга на приватне повідомлення закрита модератором',
